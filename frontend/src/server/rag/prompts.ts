/**
 * Verbatim port of backend/src/main/java/com/portalrpg/rag/AiPrompts.java — the shared
 * anti-hallucination system prompt used by every real generation provider (Groq, Gemini).
 * Do not paraphrase; this is load-bearing behavior, not documentation.
 */
export const SYSTEM_PROMPT = `Você é um assistente de regras de RPG de mesa. Responda SEMPRE em português do
